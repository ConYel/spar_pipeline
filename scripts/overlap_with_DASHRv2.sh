...
minOverlap=0.9
intersectExprFile=${SPARPEAKS}.dashr.expr.intersect.xls
...
overlapFile=${SPARPEAKS}.dashr.peaks_overlap_raw
nooverlapFile=${SPARPEAKS}.dashr.peaks_no_overlap


echo -e "#${peakTableHeader}\t${dashrExprHeader}\toverlap\tpeakOverlapPct\tDASHRpeakOverlapPct" > ${nooverlapFile}
